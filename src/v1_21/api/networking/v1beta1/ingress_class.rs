...
impl IngressClass {
    ...
    ) -> Result<(http::Request<Vec<u8>>, fn(http::StatusCode) -> crate::ResponseBody<ReadIngressClassResponse>), crate::RequestError> {
...
impl crate::ListableResource for IngressClass {
    const LIST_KIND: &'static str = concat!("IngressClass", "List");
}
