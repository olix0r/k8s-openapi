...
impl StorageVersion {
    ...
    ) -> Result<(http::Request<Vec<u8>>, fn(http::StatusCode) -> crate::ResponseBody<ReadStorageVersionResponse>), crate::RequestError> {
...
impl StorageVersion {
    ...
    ) -> Result<(http::Request<Vec<u8>>, fn(http::StatusCode) -> crate::ResponseBody<ReadStorageVersionStatusResponse>), crate::RequestError> {
...
impl<'de> serde::Deserialize<'de> for StorageVersion {
...
impl serde::Serialize for StorageVersion {
