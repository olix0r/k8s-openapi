...
impl CSIStorageCapacity {
    ...
    ) -> Result<(http::Request<Vec<u8>>, fn(http::StatusCode) -> crate::ResponseBody<ReadNamespacedCSIStorageCapacityResponse>), crate::RequestError> {
...
impl<'de> serde::Deserialize<'de> for CSIStorageCapacity {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                while let Some(key) = serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        ...
                        Field::Key_maximum_volume_size => value_maximum_volume_size = serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_metadata => value_metadata = Some(serde::de::MapAccess::next_value(&mut map)?),
                        Field::Key_node_topology => value_node_topology = serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_storage_class_name => value_storage_class_name = Some(serde::de::MapAccess::next_value(&mut map)?),
                ...
                Ok(CSIStorageCapacity {
                    ...
                    storage_class_name: value_storage_class_name.ok_or_else(|| serde::de::Error::missing_field("storageClassName"))?,
                })
            }
        }
...
impl serde::Serialize for CSIStorageCapacity {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: serde::Serializer {
        ...
        if let Some(value) = &self.maximum_volume_size {
            serde::ser::SerializeStruct::serialize_field(&mut state, "maximumVolumeSize", value)?;
        }
        serde::ser::SerializeStruct::serialize_field(&mut state, "metadata", &self.metadata)?;
        if let Some(value) = &self.node_topology {
            serde::ser::SerializeStruct::serialize_field(&mut state, "nodeTopology", value)?;
        }
        serde::ser::SerializeStruct::serialize_field(&mut state, "storageClassName", &self.storage_class_name)?;
