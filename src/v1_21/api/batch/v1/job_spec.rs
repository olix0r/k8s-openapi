            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                while let Some(key) = serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        ...
                        Field::Key_completion_mode => value_completion_mode = serde::de::MapAccess::next_value(&mut map)?,
...
impl serde::Serialize for JobSpec {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: serde::Serializer {
        ...
        if let Some(value) = &self.completion_mode {
            serde::ser::SerializeStruct::serialize_field(&mut state, "completionMode", value)?;
        }
