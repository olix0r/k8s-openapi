        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                while let Some(key) = serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        Field::Key_allocate_load_balancer_node_ports => value_allocate_load_balancer_node_ports = serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_cluster_ip => value_cluster_ip = serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_cluster_i_ps => value_cluster_i_ps = serde::de::MapAccess::next_value(&mut map)?,
                        ...
                        Field::Key_internal_traffic_policy => value_internal_traffic_policy = serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_ip_families => value_ip_families = serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_ip_family_policy => value_ip_family_policy = serde::de::MapAccess::next_value(&mut map)?,
                        Field::Key_load_balancer_class => value_load_balancer_class = serde::de::MapAccess::next_value(&mut map)?,
...
impl serde::Serialize for ServiceSpec {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: serde::Serializer {
        ...
        if let Some(value) = &self.allocate_load_balancer_node_ports {
            serde::ser::SerializeStruct::serialize_field(&mut state, "allocateLoadBalancerNodePorts", value)?;
        }
        ...
        if let Some(value) = &self.cluster_i_ps {
            serde::ser::SerializeStruct::serialize_field(&mut state, "clusterIPs", value)?;
        }
        ...
        if let Some(value) = &self.internal_traffic_policy {
            serde::ser::SerializeStruct::serialize_field(&mut state, "internalTrafficPolicy", value)?;
        }
        if let Some(value) = &self.ip_families {
            serde::ser::SerializeStruct::serialize_field(&mut state, "ipFamilies", value)?;
        }
        if let Some(value) = &self.ip_family_policy {
            serde::ser::SerializeStruct::serialize_field(&mut state, "ipFamilyPolicy", value)?;
        }
        if let Some(value) = &self.load_balancer_class {
            serde::ser::SerializeStruct::serialize_field(&mut state, "loadBalancerClass", value)?;
        }
