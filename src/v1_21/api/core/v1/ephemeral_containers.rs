...
impl EphemeralContainers {
    ...
    ) -> Result<(http::Request<Vec<u8>>, fn(http::StatusCode) -> crate::ResponseBody<ReadNamespacedPodEphemeralcontainersResponse>), crate::RequestError> {
...
impl<'de> serde::Deserialize<'de> for EphemeralContainers {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: serde::de::MapAccess<'de> {
                ...
                while let Some(key) = serde::de::MapAccess::next_key::<Field>(&mut map)? {
                    match key {
                        ...
                        Field::Key_ephemeral_containers => value_ephemeral_containers = Some(serde::de::MapAccess::next_value(&mut map)?),
                ...
                Ok(EphemeralContainers {
                    ephemeral_containers: value_ephemeral_containers.ok_or_else(|| serde::de::Error::missing_field("ephemeralContainers"))?,
...
impl serde::Serialize for EphemeralContainers {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> where S: serde::Serializer {
        ...
        serde::ser::SerializeStruct::serialize_field(&mut state, "ephemeralContainers", &self.ephemeral_containers)?;
